...
MODELING_SCRIPT="/home/nay/Documentos/Projetos/SteamDB-Analytics-Pipeline/scripts/modeling/create_dim_games.py"
...
CRON_JOB="50 19 * * * python3 $PROCESSING_SCRIPT >> /home/nay/Documentos/Projetos/SteamDB-Analytics-Pipeline/logs/processing_log.txt 2>&1 && \
python3 $MODELING_SCRIPT >> /home/nay/Documentos/Projetos/SteamDB-Analytics-Pipeline/logs/modeling_log.txt 2>&1 &&"
...
#python3 $EXTRACTION_SCRIPT >> /home/nay/Documentos/Projetos/SteamDB-Analytics-Pipeline/logs/extraction_log.txt 2>&1 && \
#python3 $PROCESSING_SCRIPT >> /home/nay/Documentos/Projetos/SteamDB-Analytics-Pipeline/logs/processing_log.txt 2>&1 && \
#python3 $MODELING_SCRIPT >> /home/nay/Documentos/Projetos/SteamDB-Analytics-Pipeline/logs/modeling_log.txt 2>&1 && \
